  ...
  return (
    <div className="py-[4rem]  flex flex-col gap-y-[7rem] bg-gradient-to-b from-[#fbe7ff] from-20% via-[#C7BFF0] via-60%  to-[#B0A5F1] to-900%">
      ...
      <div className="w-3/4 m-auto  rounded-lg">
        <Accordion
          title="What is PhishHook?"
          answer=" PhishHook is a Chrome Extension designed to help users detect
              phishing websites. It uses advanced AI and data training to
              determine if a website is safe or a potential phishing threat.
              Additionally, PhishHook can show you the legitimate version of a
              site if you encounter a fake one."
        />
        <Accordion
          title="How does PhishHook help protect me from phishing websites?"
          answer=" PhishHook detects phishing websites using AI and data training.
        ...
        <Accordion
          ...
          answer="Once you have PhishHook installed, it will automatically check
              the websites you visit and notify you if a site is safe or a
              potential phishing threat."
        />
        <Accordion
          title="Is PhishHook free to use?"
          answer="Yes, PhishHook is free to use. We want to help everyone stay safe
              online."
        />
        <Accordion
          title="How is user data handled by PhishHook?"
          answer=" We take user privacy seriously. PhishHook does not collect or
